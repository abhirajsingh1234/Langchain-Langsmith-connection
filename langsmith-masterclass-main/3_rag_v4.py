...
PDF_PATH = "magical_forest_story.pdf"  # change to your file
...
def setup_pipeline(pdf_path: str, chunk_size=1000, chunk_overlap=150, embed_model_name="nomic-embed-text:latest", force_rebuild=False):
...
def setup_pipeline_and_query(
    ...
    return chain.invoke(
        question,
        config={"run_name": "pdf_rag_query_optimized", "tags": ["qa"], "metadata": {"k": 4}}
    )

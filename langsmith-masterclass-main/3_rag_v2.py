...
# ---------- traced setup steps ----------
@traceable(name='pdf loader')
def load_pdf(path: str):
    loader = PyPDFLoader(path)
    return loader.load()  # list[Document]

@traceable(name = 'documents splitter')
...
@traceable(name = 'pipeline creation')
...
config = {
    "run_name": "pdf_rag_query_with_traceable"
}
